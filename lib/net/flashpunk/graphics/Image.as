package net.flashpunk.graphics 
{
	...
	public class Image extends Graphic
	{
		...
		public static function createRoundRect(width:uint, height:uint, color:uint = 0xFFFFFF, ellipse:Number = 1):Image
		{
			FP.sprite.graphics.clear();
			FP.sprite.graphics.beginFill(0xFFFFFF);
			FP.sprite.graphics.drawRoundRect(0, 0, width, height, ellipse);
		...
		public static function createButtonUp(width:uint, height:uint, color:uint = 0xFFFFFF, ellipse:Number = 1):Image
		{
			FP.sprite.graphics.clear();
			FP.sprite.graphics.beginFill(0xFFFFFF);
			FP.sprite.graphics.lineStyle(1, 0, 1, true);
			var gradientBoxMatrix:Matrix = new Matrix();
            gradientBoxMatrix.createGradientBox(width, height, Math.PI/2, 0, 0);
			FP.sprite.graphics.lineGradientStyle(GradientType.LINEAR, [0xC8C8C8,
            0xA0A0A0, 0x6E6E6E], [1, 1, 1], [0, 128, 255], gradientBoxMatrix);
			// Background
			FP.sprite.graphics.beginGradientFill(GradientType.LINEAR, [0xE6E6E6,
            0xD2D2D2, 0xBEBEBE], [1, 1, 1], [0, 128, 255], gradientBoxMatrix);
			FP.sprite.graphics.drawRoundRect(0, 0, width, height, ellipse);
			FP.sprite.graphics.endFill();
			var data:BitmapData = new BitmapData(width+10, height+10, true, 0);
			data.draw(FP.sprite);
		...
		public static function createButtonDown(width:uint, height:uint, color:uint = 0xFFFFFF, ellipse:Number = 1):Image
		{
			FP.sprite.graphics.clear();
			FP.sprite.graphics.beginFill(0xFFFFFF);
			FP.sprite.graphics.lineStyle(1, 0, 1, true);
			var gradientBoxMatrix:Matrix = new Matrix();
            gradientBoxMatrix.createGradientBox(width, height, Math.PI/2, 0, 0);
			FP.sprite.graphics.lineGradientStyle(GradientType.LINEAR, [0x009BFC,    
			0x0086D7, 0x0074B9], [1, 1, 1], [0, 128, 255], gradientBoxMatrix);
			// Background
			FP.sprite.graphics.beginGradientFill(GradientType.LINEAR, [0xE6E6E6,
            0xD2D2D2, 0xBEBEBE], [1, 1, 1], [0, 128, 255], gradientBoxMatrix);
			FP.sprite.graphics.drawRoundRect(0, 0, width, height, ellipse);
